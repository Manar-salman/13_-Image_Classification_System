...
### Project Overview
This project implements a Deep Learning application using Convolutional Neural Networks (CNN) to classify images into 10 distinct categories.
### نظرة عامة على المشروع
يقوم هذا المشروع بتنفيذ تطبيق للتعلم العميق باستخدام الشبكات العصبية الالتفافية (CNN) لتصنيف الصور إلى 10 فئات مختلفة.

---

### Requirements | المتطلبات
* **Environment / البيئة:** Google Colab (GPU: T4).
* **Libraries / المكتبات:** `TensorFlow`, `Keras`, `NumPy`, `Matplotlib`.
* **Dataset / البيانات:** CIFAR-10.
...
تم تحسين البيانات باستخدام مولد بيانات اصطناعي لضمان الجودة.
